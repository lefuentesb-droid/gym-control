...
public class Pago {
    ...
    @ManyToOne//ManyToOne por que muchos pagos pueden pertenecer a un socio
    @JoinColumn(name = "socio_id")
    private Socio socio;

    //Relacion con membresia (FK)
    @ManyToOne //ManyToOne por que muchos pagos pueden pertenecer a una membresia
    @JoinColumn(name = "membresia_id")
    private Membresia membresia;

    //Relacion con metodo_pago (FK)
    @ManyToOne //ManyToOne por que muchos pagos pueden pertenecer a un metodo de pago
